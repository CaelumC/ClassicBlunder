				...
				if(!applied)
					...
					switch(owner.Class)
						...
						if("Reaper")
							...
							offense=0.5 * SMod
							speed=0.5 * SMod
							passives = list("SlayerMod" = 0.5, "CriticalChance" = 10, "CriticalDamage" = 0.25, "Instinct" = 1)
				..()
		three
				...
				if(!applied)
					...
					switch(owner.Class)
						...
						if("Reaper")
							...
							offense=0.5 * SMod
							speed=0.5 * SMod
							passives = list("SlayerMod" = 0.5, "CriticalChance" = 10, "CriticalDamage" = 0.25, "Instinct" = 1, "Deicide" = 1)
				..()
		six
