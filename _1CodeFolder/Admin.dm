var/list
	CodedAdmins=list("NWKY"=3, "CaelumZ"=4, "Sunshine Jesse"=4, "Nightmare Zarkus"=4, "NeoGalaxyEyesPhotonDragon"=4, "Lanni.k"=4, "Shadeofwar"=4, "Antenora Luxuria"=4, "Admindred"=4, "Hadoke"=3)
	Admins=new
	Mappers=new
	Punishments=new
