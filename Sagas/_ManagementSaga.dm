					...
					/*	switch(src.KeybladeType)
						...
						if(src.KeybladeType=="Shield")
							...
							while(confirmshield!="Yes")
								...
								switch(choice2)
									if("Sonic Blade")
										confirm=alert(src, "Quickly dash towards your opponent three times.", "Yes", "No")
									if("Strike Raid")
										confirm=alert(src, "Throw your Keyblade at your opponent in the form of an autohit wave.", "Yes", "No")
									if("Magnet Burst")
										confirm=alert(src, "A weak Area-Of-Effect move that pulls in everyone nearby and stuns.", "Yes", "No")
							switch(choiceshield)
								if("Sonic Blade")
						...
						if(src.KeybladeType=="Sword")
							...
							while(confirm2!="Yes")
								...
								switch(choice2)
									if("Sonic Blade")
										confirm=alert(src, "Quickly dash towards your opponent three times. Upgrading boosts the range, damage, and number of rounds.", "Yes", "No")
									if("Strike Raid")
										confirm=alert(src, "Throw your Keyblade at your opponent in the form of an autohit wave. Upgrading boosts the damage and causes you to fire it off multiple times.", "Yes", "No")
									if("Magnet Burst")
										confirm=alert(src, "A weak Area-Of-Effect move that pulls in everyone nearby and stuns. Upgrading boosts the range and greatly boosts the damage.", "Yes", "No")
							switch(choice2)
								if("Sonic Blade")
							...
							while(confirm3!="Yes")
								...
								choice3=input(src, "What tier 2 skill do you want?", "Martial Keyblade Skill") in Choices2
								switch(choice3)
									if("Ripple Drive")
										confirm=alert(src, "Release a powerful wave of energy with a strong knockback.", "Yes", "No")
									if("Stun Impact")
										confirm=alert(src, "Queues up a stunning attack.", "Yes", "No")
									if("Explosion")
										confirm=alert(src, "Queue up a weak hit that follows up with a powerful explosive one.", "Yes", "No")
							switch(choice3)
								if("Ripple Drive")
